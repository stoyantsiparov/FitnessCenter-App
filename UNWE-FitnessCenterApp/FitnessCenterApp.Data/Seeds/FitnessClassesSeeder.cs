    ...
    public static void Seed(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<FitnessClass>().HasData(
            new FitnessClass
            {
                ...
                Name = "Morning Yoga",
                InstructorId = 1,
                ScheduleDateTime = DateTime.Parse("2024-12-05T07:00:00"),
                Duration = 60,
            ...
            new FitnessClass
            {
                ...
                Name = "HIIT Challenge",
                InstructorId = 2,
                ScheduleDateTime = DateTime.Parse("2024-12-05T18:00:00"),
                Duration = 45,
            ...
            new FitnessClass
            {
                ...
                Name = "Zumba Dance",
                InstructorId = 3,
                ScheduleDateTime = DateTime.Parse("2024-12-06T10:00:00"),
                Duration = 60,
            ...
            new FitnessClass
            {
                ...
                Name = "Pilates Core",
                InstructorId = 4,
                ScheduleDateTime = DateTime.Parse("2024-12-07T08:30:00"),
                Duration = 60,
            ...
            new FitnessClass
            {
                ...
                InstructorId = 5,
                ScheduleDateTime = DateTime.Parse("2024-12-07T17:00:00"),
                Duration = 45,
            ...
            new FitnessClass
            {
                ...
                Name = "ММА Essentials",
                InstructorId = 6,
                ScheduleDateTime = DateTime.Parse("2024-12-08T20:00:00"),
                Duration = 30,
